...
def verify():
    ...
    if max_diff < 1e-4:
        print("\n✅ PASSED: ONNX model matches PyTorch model.")
        return True
    else:
        print("\n⚠️ WARNING: Differences computed. Please check if acceptable.")
